...
if __name__ == '__main__':
    ...
    parser.add_argument('-lp', '--leaderboard_data_path', type=str, default='./Data/Image_Leaderboard') #/scratch/connectome/nemod/FastMRI/Data/image_Leaderboard
    """
    Modify Path Below To Test Your Results
    """
    parser.add_argument('-yp', '--your_data_path', type=str, default='./Data/Image_Reconsturcted')
