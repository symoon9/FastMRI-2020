...
class UNet(nn.Module):
    def __init__(self, block=ConvBlock,dim=32):
        ...
        self.ConvBlock1 = ConvBlock(color_range, dim, strides=1)
        ...
        self.conv10 = nn.Conv2d(dim, color_range, kernel_size=3, stride=1, padding=1)
...
class Uformer(nn.Module):
    def __init__(self, img_size=128, in_chans=1,
