...
class EDCNN(nn.Module):
    ...
    def __init__(self, in_ch=1, out_ch=32, output=1, sobel_ch=32):
        ...
        if in_ch != output:
            self.conv0 = nn.Conv2d(in_ch, output, kernel_size=3, stride=1, padding=1)
